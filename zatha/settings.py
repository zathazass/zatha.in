"""
Django settings for zatha project.
...
SECRET_KEY = 'django-insecure-u0v=2_47xxi#%gvg34^w*l3vm@)sk*c*8fg5=g25p6q5u9+#tw'
...
WSGI_APPLICATION = 'zatha.wsgi.application'
